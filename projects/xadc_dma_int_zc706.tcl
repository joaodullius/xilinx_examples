...
#
# xadc_dma_int_zc706.tcl: Tcl script for re-creating project 'xadc_dma_zc706'
#
# Generated by Vivado on Wed Jan 23 09:59:10 -02 2019
...
#
# 1. This project restoration tcl script (xadc_dma_int_zc706.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/joaodullius/work/xilinx_examples/projects/xadc_dma_zc706/xadc_dma_zc706.srcs/sources_1/imports/wrappers/xadc_dma_wrapper.vhd"
#
...
set _xil_proj_name_ "xadc_dma_zc706"
...
set script_file "xadc_dma_int_zc706.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/xadc_dma_zc706"]"
...
set files [list \
 [file normalize "${origin_dir}/wrappers/xadc_dma_wrapper.vhd" ]\
]
...
set file "imports/wrappers/xadc_dma_wrapper.vhd"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "xadc_dma_wrapper" -objects $obj
...
# Proc to create BD xadc_dma
proc cr_bd_xadc_dma { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name xadc_dma
...
connect_bd_intf_net -intf_net [get_bd_intf_nets tlast_gen_0_m_axis] [get_bd_intf_pins axi_dma/S_AXIS_S2MM] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_intf_nets tlast_gen_0_m_axis]
  ...
  connect_bd_net -net axi_dma_s2mm_introut [get_bd_pins axi_dma/s2mm_introut] [get_bd_pins system_ila_0/probe4] [get_bd_pins xlconcat_0/In1]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets axi_dma_s2mm_introut]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins system_ila_0/probe0] [get_bd_pins tlast_gen_0/pkt_length]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets axi_gpio_0_gpio_io_o]
  connect_bd_net -net eoc_out [get_bd_pins system_ila_0/probe2] [get_bd_pins xadc_wiz_0/eoc_out]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets eoc_out]
  connect_bd_net -net eos_out [get_bd_pins system_ila_0/probe3] [get_bd_pins xadc_wiz_0/eos_out]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets eos_out]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma/m_axi_s2mm_aclk] [get_bd_pins axi_dma/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins tlast_gen_0/aclk] [get_bd_pins xadc_wiz_0/s_axi_aclk] [get_bd_pins xadc_wiz_0/s_axis_aclk]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_dma/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn] [get_bd_pins tlast_gen_0/resetn] [get_bd_pins xadc_wiz_0/s_axi_aresetn]
  connect_bd_net -net xadc_wiz_0_ip2intc_irpt [get_bd_pins system_ila_0/probe1] [get_bd_pins xadc_wiz_0/ip2intc_irpt] [get_bd_pins xlconcat_0/In0]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets xadc_wiz_0_ip2intc_irpt]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins system_ila_0/probe5] [get_bd_pins xlconcat_0/dout]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
...
# End of cr_bd_xadc_dma()
cr_bd_xadc_dma ""
set_property IS_MANAGED "0" [get_files xadc_dma.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files xadc_dma.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files xadc_dma.bd ] 
